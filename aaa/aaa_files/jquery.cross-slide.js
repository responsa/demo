		...
		(function(proceed) {
			...
			function create_chain(i, chainf) {
				...
				if (i % 2 == 0) {
					...
					if ( ! to_anim.opacity || to_anim.opacity == 'undefined' ) {/*$.isEmptyObject(to_anim)) {*/ /* PATCH OD */
						var newf = function() {
							callback(i_to, img_to, i_from, img_from);
							img_to.css(to_init);
							img_from[animate](from_anim, fade_ms, 'linear', chainf);
						};
					} else if ( ! from_anim.opacity || from_anim.opacity == 'undefined' ) {/*$.isEmptyObject(to_anim)) {*/ /* PATCH OD */
						var newf = function() {
							callback(i_to, img_to, i_from, img_from);
							img_to.css(to_init);
