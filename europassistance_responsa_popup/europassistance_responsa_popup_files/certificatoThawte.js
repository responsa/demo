...
document.write("<a HREF=\"" + u1 + "\" tabindex=\"-1\" onmousedown=\"return v_mDown(event);\" target=\"THAWTE_Splash\"><img border=\"0\" src='/_layouts/15/ea/web/images/Thwate.jpg' width=\"65px\" height=\"15\"></A>");
// PTP
if((v_ua.indexOf("msie") != -1) && (ver >= 7)) {
 ...
 if ((plat >= 5.1) && (plat != 5.2)) {
     ...
     if (document.getElementById('RibbonContainer') == null) {
